...
ready = input(("\nHi there, "+ (user_name) + "! welcome to your very own story adventure, where you have a single objective. Get home. Ready to begin? (Yes/No) "))
...
answer = input("\nToday's day is September 7th, 1990. You have just finished your work day and have decided to head back home, which is30 minutes away by walking, or 10 minutes away by cab. You think about which option you would like to choose. (cab / walk)\n")

if answer.lower() == "walk":               #Path for WALK
    
    print("(you decided to walk.)\n\nYou start to walk home, as you do you notice something out of the lower corner of your eye, something shiny! you stop to take a look at the object and realise that the single glare you saw was the combined effort from multiple coins. (you start to count the coins.) ")
    
    nickles = int(input("Enter the amount of nickels you found: " ))

    loonies = int(input("Enter the amount of loonies you found: " ))

    dimes = int(input("Enter the amount of dimes you found: " ))

    change = float((nickles*0.05) + (loonies*1) + (dimes*0.1) )

    print(("you found $ %.2f " % (change) + " in change!" ))

    answer2 = input("\nyou decide that you would like to go to a nearby convient store and spend your money on something small. You continue to walk up the street to the nearest conivence store, when you are suddenly stopped by an armed man in a black mask who demands your wallet. You quickly think of the best possible solution. (Run/hand over wallet) ")
    ...
    if answer4.lower() == "lie":
    ...
    elif answer4.lower() == "truth":                      #Do choices for this one too, try to include something else we've learned.
        ...
        if rps == "yes":
            ...
            print("After that point, the car fell silent. After arriving at your home, you reflect upon the strange experience you've just had.")
